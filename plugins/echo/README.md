...
This is a distributed HTTP cache module for Echo based on [Souin](https://github.com/HobMartin/souin) cache.  
...
See the [Souin](https://github.com/HobMartin/souin) configuration for the full configuration, and its associated [development echo middleware](https://github.com/HobMartin/souin/blob/master/plugins/echo)  
