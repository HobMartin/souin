...
This is a distributed HTTP cache module for Kratos based on [Souin](https://github.com/HobMartin/souin) cache.  
...
See the [Souin](https://github.com/HobMartin/souin) configuration for the full configuration, and its associated [development kratos middleware](https://github.com/HobMartin/souin/blob/master/plugins/kratos)  
