...
This is a distributed HTTP cache module for Skipper based on [Souin](https://github.com/HobMartin/souin) cache.  
...
See the full detailled configuration [here](https://github.com/HobMartin/souin#optional-configuration).

Other resources
---------------
You can find an example for a docker-compose stack inside the `examples` folder.  
See the [Souin](https://github.com/HobMartin/souin) configuration for the full configuration, and its associated [development skipper middleware](https://github.com/HobMartin/souin/blob/master/plugins/skipper)  
